...
class ConfigFilesService extends BasicService
{
     ...
     * @return boolean
     */
    public function createFile($filename, $data = [], $scope = '@app')
    {
        $this->clearErrors();
     ...
     * @return boolean
     */
    public function updateFile($filename, $data, $skipCheck = false, $scope = '@app')
    {
        if (!is_array($data)) {
            throw new InvalidParamException('$data should be an array, "' . gettype($data) . '" given.');
        }
     ...
     */
    private function addError($message, $details = [])
    {
        $this->_errors = [
            'message' => $message,
            'details' => $details,
