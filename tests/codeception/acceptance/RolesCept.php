...
$I->amOnPage('/index-test.php/usermanager/admin/roles/TestName');
...
$I->amOnPage('/index-test.php/usermanager/admin/roles');
...
$I->amOnPage('/index-test.php/usermanager/admin/roles/TestNameA');
$I->click('TestNameB', '#add-role-modal');
$I->amOnPage('/index-test.php/usermanager/admin/roles/TestNameB');
